...
export default function Contact(){
  ...
  const onSubmit = async (e) => {
    ...
    try {
      // This would normally call the backend. For now we simulate success.
  ...
  return (
    <section id="contacto" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-10 items-center">
        <div>
          <h2 className="text-3xl sm:text-4xl font-black tracking-tight">Reserva tu clase de prueba</h2>
          <p className="mt-3 text-gray-600">Déjanos tus datos y te contactamos para coordinar horario y nivel.</p>
          ...
          <form onSubmit={onSubmit} className="mt-8 space-y-4">
            ...
            <button className="inline-flex items-center rounded-full bg-emerald-600 text-white px-6 py-3 font-semibold shadow-sm hover:bg-emerald-700 transition-colors">
        ...
        <div className="relative rounded-2xl overflow-hidden border border-black/10 shadow-sm p-6 bg-gradient-to-br from-emerald-50 to-white">
